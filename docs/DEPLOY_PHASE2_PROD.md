...
```bash
cd /home/clawd/.openclaw/skills/brainx-v3
...
```bash
./brainx-v3 health
./brainx-v3 add --type learning --content "Contacto: test@example.com" --context prod-test --category learning --tags pii
./brainx-v3 search --query "contacto" --limit 3
./brainx-v3 metrics --days 7 --json
