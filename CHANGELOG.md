...
### Validation
- All harvesters: `node --check` OK + dry-runs confirm ACP discovery; real `session-harvester --agent sonnet` wrote 36 memories from sonnet's ACP reasoning. skills/brainx unit suite `49/49`. Plugin suite `213/213`.
